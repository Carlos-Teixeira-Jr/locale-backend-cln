        ...
        <body>
          <div class="container">
            <div class="sub-container">
              ...
              <p class="text">Para garantir a segurança da sua conta, precisamos verificar o seu endereço de email. Por favor, use o seguinte código de verificação para confirmar o seu cadastro:</p>
        ...
        <body>
          <div class="container">
            <div class="sub-container">
              ...
              <p class="text">uma senha de acesso foi criada automaticamente para sua conta. Recomendamos que guarde essa senha ou troque-a na página de dados do usuário.</p>
